                ...
                ColumnLayout {
                    ...
                    Rectangle {
                        ...
                        Row {
                            ...
                            Text { text: "Sr"; width: root.colSr; color: "#FFF"; font.bold: true }

                            Text {
                                text: root.activeFilter === "Created" ? "Report Type" : "File Name"
                                width: root.activeFilter === "Created" ? root.colType : root.colFile
                                color: "#FFF"; font.bold: true
                            }

                            Text {
                                text: root.activeFilter === "Deleted" ? "Deleted On"
                                      : root.activeFilter === "Copied" ? "Copied On"
                                      : "Generated Date"
                                width: root.colDate
                                color: "#FFF"; font.bold: true
                            }
                            ...
                            Text {
                                text: root.activeFilter === "Created" ? "From"
                                      : "By"
                                width: root.colFrom
                                color: "#FFF"; font.bold: true
                            }
                            ...
                            Text {
                                text: root.activeFilter === "Created" ? "To"
                                      : ""
                                width: root.colTo
                            ...
                            Text {
                                text: root.activeFilter === "Created" ? "Generated By"
                                      : ""
                                width: root.colBy
                                color: "#FFF"; font.bold: true
                            }
                    ...
                    ListView {
                        ...
                        model: GlobalState.reportsLogModel
                        ...
                        delegate: Rectangle {
                            ...
                            visible: {
                                if (root.activeFilter === "Created") return action === "Created"
                                if (root.activeFilter === "Deleted") return action === "Deleted"
                                if (root.activeFilter === "Copied") return action === "Copied"
                                return true
                            }
                            ...
                            Row {
                                ...
                                // CREATED = RESTORED FULL VIEW
                                Text {
                                    text: root.activeFilter === "Created" ? type : fileName
                                    width: root.activeFilter === "Created" ? root.colType : root.colFile
                                }
                                ...
                                Text {
                                    text: root.activeFilter === "Created" ? from : by
                                    width: root.colFrom
                                }
